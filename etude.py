...
hurst_methods = {
    "SWV LD 1": HurstMethodType.SCALED_WINDOWED_VARIANCE,
    "SWV LD 2": HurstMethodType.SCALED_WINDOWED_VARIANCE,
    "AGV": HurstMethodType.AGGREGATE_VARIANCE,
    "AM": HurstMethodType.ABSOLUTE_MOMENTS,
    "DFA": HurstMethodType.DFA_ANALYSIS,
    "HIG": HurstMethodType.HIGUCHI_ANALYSIS,
    "TTA": HurstMethodType.TTA_ANALYSIS,
}
methods_params = [
...
#     nb_simulations=1000,
#     simulation_length=[250, 500, 750, 1000, 1500, 2000],
